...
# MAGIC %md
# MAGIC 1. Create metrics per airline dataframe
# MAGIC 2. Create metric per origin dataframe
# MAGIC 3. Create total metrics dataframe
# MAGIC 4. Create metrics per terminal dataframe
...
columns = ['flightStatus', 'airlineName', 'originName', 'viaName', 'trafficType','aircraftTerminal']
df[columns].head()
